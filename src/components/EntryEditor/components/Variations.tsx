...
import { Card, Button, Stack, FormControl, TextInput, Textarea, IconButton, Box, Grid, Note, Flex, Select, Heading, Text } from '@contentful/f36-components';
  ...
  return (
    <Card padding="default">
      <Box paddingLeft="spacingM" paddingRight="spacingM">
        <Heading marginBottom="spacingL">Step 3: Configure Variations</Heading>
        ...
        <Stack spacing="spacingL" flexDirection="column" alignItems="stretch">
          {formState.variations.map((variation: any, index: number) => (
              <Card key={index} padding="default" style={{ backgroundColor: '#fafbfc' }}>
